...
#import "LLPhotoBrowserDefine.h"

@interface LLPhotoBrowserManager : NSObject
...
/**
 ...
 @return array
 */
- (NSArray<LLPhotoBrowserModel *> *)getAllAssetInPhotoAlbumWithAscending:(BOOL)ascending
...
/**
 ...
 @param allowSelectVideo 是否可以选择视频
 @param allowSelectImage 是否可以选择图片
 @return LLPhotoBrowserAlbumModel
 */
- (LLPhotoBrowserAlbumModel *)getCameraRollAlbumList:(BOOL)allowSelectVideo
                                     allowSelectImage:(BOOL)allowSelectImage;
...
- (void)getCameraRollAlbumList:(BOOL)allowSelectVideo
              allowSelectImage:(BOOL)allowSelectImage
                      complete:(void (^)(LLPhotoBrowserAlbumModel * album))complete;
...
- (void)getPhotoAblumList:(BOOL)allowSelectVideo
         allowSelectImage:(BOOL)allowSelectImage
                 complete:(void (^)(NSArray<LLPhotoBrowserAlbumModel *> *))complete;

/**
 将result中对象转换成LLPhotoBrowserModel
 ...
 @return array
 */
- (NSArray<LLPhotoBrowserModel *> *)getPhotoInResult:(PHFetchResult<PHAsset *> *)result
                                     allowSelectVideo:(BOOL)allowSelectVideo
                                     allowSelectImage:(BOOL)allowSelectImage
                                       allowSelectGif:(BOOL)allowSelectGif
                                 allowSelectLivePhoto:(BOOL)allowSelectLivePhoto;
 ...
 */
- (void)requestSelectedImageForAsset:(LLPhotoBrowserModel *)model
 ...
 */
- (void)exportEditVideoForAsset:(AVAsset *)asset range:(CMTimeRange)range type:(LLExportVideoType)type complete:(void (^)(BOOL isSuc, PHAsset * asset))complete;
...
/**
 ...
 @param type 视频导出格式
 */
- (void)exportVideoForAsset:(PHAsset *)asset type:(LLExportVideoType)type complete:(void (^)(NSString * exportFilePath, NSError * error))complete;
 ...
 */
- (void)exportVideoForAsset:(PHAsset *)asset type:(LLExportVideoType)type presetName:(NSString *)presetName complete:(void (^)(NSString * exportFilePath, NSError * error))complete;
 ...
 */
- (void)exportVideoForAsset:(PHAsset *)asset type:(LLExportVideoType)type renderSize:(CGSize)renderSize complete:(void (^)(NSString * exportFilePath, NSError * error))complete;
 ...
 */
- (void)exportVideoForAsset:(PHAsset *)asset type:(LLExportVideoType)type renderSize:(CGSize)renderSize watermarkImage:(UIImage *)watermarkImage watermarkLocation:(LLWatermarkLocation)location imageSize:(CGSize)imageSize complete:(void (^)(NSString * exportFilePath, NSError * error))complete;
...
/**
 ...
 @param imageSize 水印大小
 */
- (void)exportVideoForAsset:(PHAsset *)asset type:(LLExportVideoType)type presetName:(NSString *)presetName watermarkImage:(UIImage *)watermarkImage watermarkLocation:(LLWatermarkLocation)location imageSize:(CGSize)imageSize complete:(void (^)(NSString * exportFilePath, NSError * error))complete;
 ...
 */
- (void)exportVideoForAsset:(PHAsset *)asset type:(LLExportVideoType)type presetName:(NSString *)presetName effectImage:(UIImage *)effectImage birthRate:(NSInteger)birthRate velocity:(CGFloat)velocity complete:(void (^)(NSString * exportFilePath, NSError * error))complete;

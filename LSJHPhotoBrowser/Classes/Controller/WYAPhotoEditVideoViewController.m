...
- (void)analysisAssetImages
{
    ...
    WeakSelf(weakSelf);
    [[WYAPhotoBrowserManager sharedPhotoBrowserManager] requestVideoForAsset:self.model.asset
...
- (void)btnDone_click
{
    ...
    [UIView wya_toastWithMessage:@"保存视频中" imageString:@"spin" autoRotation:YES imageType:WYAToastImageTypeSVG sourceInWYAKitBundle:YES autoDismiss:NO bgViewUserInteractionUse:NO];

    WYAPhotoBrowser * nav = (WYAPhotoBrowser *)self.navigationController;

    WeakSelf(weakSelf);
    __weak typeof(nav) weakNav = nav;
    [[WYAPhotoBrowserManager sharedPhotoBrowserManager] exportEditVideoForAsset:_avAsset

...
@interface LLPhotoBrowserModel : NSObject
/// 资源
@property (nonatomic, strong) PHAsset * asset;
/// asset类型
@property (nonatomic, assign) LLAssetMediaType type;
/// 视频时长
...
@interface LLPhotoBrowserAlbumModel : NSObject
...
@property (nonatomic, strong) NSArray<LLPhotoBrowserModel *> * models;

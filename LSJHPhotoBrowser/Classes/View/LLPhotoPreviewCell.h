...
@class LLPhotoBrowserModel, PHAsset, LLPreviewView, LLProgressView;
...
@property (nonatomic, strong) LLPreviewView * previewView;
...
@class LLPreviewImageAndGif, LLPreviewLivePhoto, LLPreviewVideo, LLPreviewNetVideo;

//预览大图，image、gif、livephoto、video
@interface LLPreviewView : UIView

@property (nonatomic, assign) BOOL showGif;
@property (nonatomic, assign) BOOL showLivePhoto;

@property (nonatomic, strong) LLPreviewImageAndGif * imageGifView;
@property (nonatomic, strong) LLPreviewLivePhoto * livePhotoView;
@property (nonatomic, strong) LLPreviewVideo * videoView;
@property (nonatomic, strong) LLPreviewNetVideo * netVideoView;
@property (nonatomic, strong) LLPhotoBrowserModel * model;
@property (nonatomic, copy) void (^singleTapCallBack)(void);
@property (nonatomic, copy) void (^longPressCallBack)(void);
...
//---------------base preview---------------
@interface LLBasePreviewView : UIView

@property (nonatomic, strong) UIImageView * imageView;
@property (nonatomic, strong) LLProgressView * indicator;
...
//---------------image、gif、net image---------------
@interface LLPreviewImageAndGif : LLBasePreviewView
...
//---------------livephoto---------------
@interface LLPreviewLivePhoto : LLBasePreviewView
...
//---------------video---------------
@interface LLPreviewVideo : LLBasePreviewView
...
//---------------net video---------------
@interface LLPreviewNetVideo : LLBasePreviewView

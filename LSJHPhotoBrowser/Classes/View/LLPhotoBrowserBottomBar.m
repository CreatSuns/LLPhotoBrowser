...
@interface LLPhotoBrowserBottomBar ()

@end

@implementation LLPhotoBrowserBottomBar
...
- (UIButton *)originalButton
{
    if (!_originalButton) {
        _originalButton = ({
            ...
            [button setImage:[UIImage ll_loadBundleImage:@"icon_photo_yuan"
                                            ClassName:NSStringFromClass(self.class) bundleName:@"LSJHPhotoBrowser"]
                    forState:UIControlStateNormal];
            [button setImage:[UIImage ll_loadBundleImage:@"icon_radio_selected"
                                            ClassName:NSStringFromClass(self.class) bundleName:@"LSJHPhotoBrowser"]
...
- (UIButton *)doneButton
{
    if (!_doneButton) {
        _doneButton = ({
            ...
            [object setTitleColor:[UIColor grayColor] forState:UIControlStateDisabled];
            [object setBackgroundImage:[UIImage ll_createImageWithColor:[UIColor lightGrayColor]] forState:UIControlStateDisabled];
            [object setBackgroundImage:[UIImage ll_createImageWithColor:random(133, 198, 234, 1)] forState:UIControlStateNormal];
            object.enabled             = NO;
            object.titleLabel.font     = FONT(15);

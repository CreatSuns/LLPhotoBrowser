...
@interface LLPhotoBrowserEditBottomBar ()

@end

@implementation LLPhotoBrowserEditBottomBar
...
- (UIButton *)centerButton
{
    if (!_centerButton) {
        _centerButton = ({
            ...
            [button setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
            [button setImage:[UIImage ll_loadBundleImage:@"icon_cameraOriginal_normal"
...
- (UIButton *)doneButton
{
    if (!_doneButton) {
        _doneButton = ({
            ...
            [button
            setBackgroundImage:[UIImage ll_createImageWithColor:[UIColor ll_hex:@"#108DE7"]]
                      forState:UIControlStateNormal];
